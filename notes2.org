...
EPOCHS = 30, BATCH_SIZE=128, ADAM OPTIMZER: 0.927 (still a bit jumpy, but the last two, three epochs stayed about 0.92).
EPOCHS = 100, BATCH_SIZE=128, ADAM OPTIMZER: 0.93x
